"""
Django settings for vastvistas project.
...
SECRET_KEY = 'django-insecure-@(^!dk)dal07ko+b+z$5+^6_m104uc5m^jgd1kbi=q%7h%ky9f'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'vastvistas_web.context_processors.configurations',
            ],
        },
    },
]
